...
if (isset($_SESSION['login'])) {
    ...
    if (isset($_POST['tambah_sub'])) {
        ...
        if ($nilai_sub_kriteria <= 100) {
            ...
            if ($tambah) {
                ...
                window.location = (href = 'cobadata_kriteria.php');
                </script>";
            } else {
                echo "<script>
    ...
    if (isset($_POST['edit_subkriteria'])) {
        ...
        //     # code...
        // }
        // echo count($_POST['id_sub_kriteria']);
        // exit();
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="update_kriteria.php?id_kriteria=<?php echo $data['id_kriteria']; ?>">
                                                ...
                                                <button type="button" class="btn btn-warning btn-xs detail_data" id="<?php echo $data['id_kriteria']; ?>"><i class="fa fa-book"></i></button>
                                            </td>
                                        </tr>
                                    <?php  } ?>
                                </tbody>
