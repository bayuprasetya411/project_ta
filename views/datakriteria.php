                        ...
                        <table id="example2" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>15</td>
                                    <td>0.15</td>
                                    <td><button type="button" id="" name="hapus" class="btn btn-danger btn-sm hapus_data"><i class="fa fa-trash"></i></button>
                                        <button type="button" id="" name="edit" class="btn btn-primary btn-sm edit_data"><i class="fa fa-wrench"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
